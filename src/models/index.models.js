...
dbdepo.Ingreso.belongsTo(dbdepo.Planoxubicacion, { foreignKey: 'planoxubicacion_id' });
dbdepo.Egreso.belongsTo(dbdepo.Planoxubicacion, { foreignKey: 'planoxubicacion_id' });
